...
const overlayCloseModal = document.querySelector('.js-overlay-close-modal-details-pokemon');
const countPokemons = document.getElementById('js-count-pokemons');

// criação por js lista de pokemons
...
overlayCloseModal.addEventListener('click', overlayCloseDetailsPokemon);
...
function openDetailsPokemon() {
    ...
    const iconTypePokemonModal = document.getElementById('js-type-modal');
    ...
    const otherAbilityPokemonModal = document.getElementById('js-other-abilities-pokemon');
    ...
    .then(response => {
        ...
        let infoPokemon = {
            ...
            otherAbility: primeiraLetraMaiuscula(data.abilities[1].ability.name),
            types: data.types,
            weight: data.weight,
            height: data.height,
        ...
        function listingWeaknesses() {
            const areaWeaknessesPokemon = document.getElementById('js-weak-area-pokemon');

            areaWeaknessesPokemon.innerHTML = "";
            ...
            .then(response => {
                ...
                weaknesses.forEach(itemType => {
                    ...
                    areaWeaknessesPokemon.appendChild(itemListWeak);
        ...
        otherAbilityPokemonModal.textContent = infoPokemon.otherAbility;
...
function overlayCloseDetailsPokemon() {
    document.documentElement.classList.remove('open-modal');
}
...
.then(response => {
    ...
    results.forEach((type, index) => {
        if(index < 18) {
            ...
            // preenchimento do select mobile type
